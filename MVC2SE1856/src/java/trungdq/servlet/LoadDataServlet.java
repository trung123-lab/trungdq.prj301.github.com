...
public class LoadDataServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = siteMaps.getProperty(ApplicationConstants.LoadDataFeature.PRODUCT_PAGE);
        try {
            Tbl_ProductDAO productDAO = new Tbl_ProductDAO();
            productDAO.addBook(); // Thêm dữ liệu mẫu, bạn có thể bỏ qua nếu không cần thiết
            List<Tbl_ProductDTO> productList = productDAO.getProducts();

            // Đặt dữ liệu vào thuộc tính của request để truyền cho JSP
